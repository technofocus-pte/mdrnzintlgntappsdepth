...
lab:
  ...
  description: +++this.label = document.createElement("input");+++
...
1.  Open Visual Studio Code using the shortcut present on the VM’s
    Desktop, select the **Extensions** icon in the navigation bar.
...
3.  Wait till the installation is complete. After installation, if the
    prompt appears and asks you if the extension 'Power Platform Tool'
...
5.  Run the pac command to see what commands are available:
     ...
     ![A black screen with white text and red rectangle with yellow and ](./media/image7.png)
...
7.  You can see what options the admin has.
...
9.  Go to the **Home page**, from the upper right corner of the screen,
...
11. Go back to the Visual Studio Code terminal, type the following
    ...
    test environment when prompted.
     ...
     +++pac auth create --name Lab --environment <Your Instance URL>+++
...
4.  Run the command below to initialize the component project.
     ...
     ![A screen shot of a computer Description automatically generated](./media/image28.png)
...
8.  If you come across a pop-up saying. Do you trust the authors of the
    file? Then click **Yes, I trust the authors**.

     ![A screenshot of a computer AI-generated content may be incorrect.](./media/image31.png)

9.  If you are asked to choose a color theme, click on Browse Color
    Themes; otherwise, ignore this and the next step.

     ![A screenshot of a computer program AI-generated content may be incorrect.](./media/image32.png)
...
12. Expand the **FirstControl** folder and select **Index.ts**.
     ...
     **Note:** On the pop-up asking, ‘Do you want to allow untrusted files
     ...
     ![A screenshot of a computer error Description automatically generated](./media/image36.png)
...
13. Paste the following two variables inside the export.
     ...
     ![A screen shot of a computer Description automatically generated](./media/image37.png)
...
14. Paste the following inside the **init()** function to create the
    HTML controls and set the label value.
     ...
     ![A screenshot of a computer program Description automatically generated](./media/image38.png)
...
16. Go to the terminal and input the following command and then enter.
    ...
    the thisrd screenshot of this step.
     ...
     ![A screen shot of a computer AI-generated content may be incorrect.](./media/image41.png)
    
     **Note:** If you receive a message that Windows Defender Firewall has blocked some features, select Allow access.
    
     ![A screenshot of a computer security alert Description automatically generated](./media/image42.png)
...
17. The test harness is effective to use early in the project to see
    ...
    an environment. You can set the values of the property to change the
    size of the control area. After you're done exploring the test
    harness, switch back to the terminal and press Ctrl-C to terminate
    the execution of the test harness.

     ![](./media/image44.png)
    
     ![A screenshot of a computer program Description automatically generated](./media/image45.png)
...
10. Select **Browse** on Import a solution dialog.
     ...
     ![A white background with black text Description automatically generated](./media/image58.png)
...
19. Select **Skip** on the welcome window.
     ...
     ![A screenshot of a phone AI-generated content may be incorrect.](./media/image67.png)
...
23. On the left toolbar, select **+** and expand **Code components**.
