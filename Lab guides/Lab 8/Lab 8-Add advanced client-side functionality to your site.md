...
11. After closing the **Visual Studio Code** tab, you will be on Power
    Pages portal.

12. Select **Sync** when prompted to synchronize the changes.
...
15. On the WebAPI webpage, you can see the Contact created earlier.
