...
4.  Fill up the few fields of the form and then select **Submit** button
    ...
    ![A white paper with black lines AI-generated content may be incorrect.](./media/image29.png)
...
5.  Once you've successfully submitted the form, return to the design
    ...
    **Note**: Try one more time if you don't get message of successful submission.
