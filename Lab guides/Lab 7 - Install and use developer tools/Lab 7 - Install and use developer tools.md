...
## **Exercise 1: Install developer tools**

In this task, you'll use a Power Platform CLI to install tools.

1.  To launch **Command Prompt**, go to the **Start** menu of the VM,
    type Command Prompt in the search box, and select **Open**.
...
6.  Run the command below to install the **Plugin Registration Tool**.
     ...
     ![A screenshot of a computer program AI-generated content may be incorrect.](./media/image6.png)
...
## **Exercise 2: Explore a registered plug-in with the plug-in registration tool**
...
4.  Sign in with your Dataverse environment credentials, i.e., Office
    365 Admin credentials. Click **Next**.
...
6.  In this case, you can see that the **Dev One** environment is
    already selected. In case the list of environments appears, pick
    your environment – **Dev One** and select **Login** again.
...
tools. When you create your own custom plug-in, you will use the Plugin
