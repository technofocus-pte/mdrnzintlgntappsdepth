...
8.  Open the new tab and go to the **Power Platform admin center** by navigating to
    +++https://admin.powerplatform.microsoft.com+++ and, if required, sign in using your given Office 365 admin tenant
    credentials.

     ![](./media/image8.png)

9.  From the left navigation pane, select **Manage** > **Environments,** and then you can see that **Dev One** is your
...
1.  Sign in to Microsoft Teams using +++https://teams.microsoft.com/+++ with your Office 365 tenant credentials.
...
6.  Enter the Team name as +++Dev Team+++, First channel name as +++DevChannel+++, and click **Private**.
...
1.  Sign in to **Microsoft Copilot Studio** with your **Office 365 admin tenant** credentials using +++https://go.microsoft.com/fwlink/?LinkId=2107702+++. Select **Sign in** or **Continue**.
...
13. **Check** the **checkbox** of **MOD Administrator** and then click on the **Select** button.
...
15. **Check** the **checkbox** of **MOD Administrator** and then click on the **Select** button.
