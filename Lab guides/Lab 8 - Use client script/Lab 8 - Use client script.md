...
## **Exercise 1: Create a model-driven app and write client script**
...
5.  In this lab, we will use a publisher with the following definition
     ...
     **Prefix** – +++example+++
     ...
     your company. In this case, we are using an example.

6.  You will now be on **New solution** dialog. You can see **Example
    Publisher ExamplePublisher)** is automatically selected from the
    dropdown of the Publisher field and then select **Create**.
...
10. Select the **Dataverse table** on the pop-up that appears.

     ![A screenshot of a computer Description automatically generated](./media/image10.png)

11. Select the **Account** table and then select **Add**.

     ![A screenshot of a computer AI-generated content may be incorrect.](./media/image11.png)
    
     **Note:** For this lab, we are using the Account table. The scripts
     and instructions below expect fields found in a form for the Account
     table.
...
15. Click on the **back arrow** to come back to the solution.
...
2.  Go to the VM’s Desktop, create a **new folder** and name it as +++Client Script Lab+++.
...
Now that your code is ready, you need to upload it to your solution.

1.  On the Power Apps portal, in your solution,
...
3.  Select the **Example-form-script.js** file you saved earlier on the
    VM’s Desktop and click on **Open**.

     ![A screenshot of a computer AI-generated content may be incorrect.](./media/image19.png)

4.  Make sure the **File Type** is **JavaScript (JS)**. Type in the **Name** – +++example-form-script+++, **Display name** –
...
1.  In your solution, select **Objects** > **Apps** > Select (not to open) **Account App** and click **Edit**.
...
3.  Expand the **Accounts form panel** from the right side of the app.
    If you see the information form and other forms. Keep the
    information form only and remove other forms. To remove them, click
    the ellipses (**...**) to the right of the form and
    select **Remove**.

     **Note:** Do not remove the information form.
...
5.  If the **Unsaved changes** pop-up appears, select **Save and
    continue**.
...
2.  To **configure the form On Load event**, select **On Load** event
...
5.  Select the **Pass execution context as first parameter** and then
    click **Done**.

     ![A screenshot of a computer Description automatically generated](./media/image33.png)

6.  To configure the Form **On Save** event, select **On Save** event
    handler and click **+Event Handler**.

     ![A screenshot of a web page Description automatically generated](./media/image34.png)
...
8.  Type the name of the function in the **Function** field. In this
     ...
     **Note:** It is not necessary to select the **Pass execution context
     as first parameter** for this function because it doesn't use it.

9.  Click **Done.**

     ![A screenshot of a computer Description automatically generated](./media/image37.png)

10. To configure the Field **On Change** event, select the **Account
...
13. Type the name of the function in the **Function** field. In this case, +++**Example.attributeOnChange**+++.
...
4.  To test the form On Load function, click on any account record in
    the list to open it. For example, click on **A. Datum Corporation
    (Sample)**.
...
7.  To test the field **On Change** function, select **Alpine Ski House (sample)** from the Account Name list.
...
10. To test the form's On Save function. Click **Save** on the newly
    edited Contoso Alpine Ski House (Sample) account.

     ![A screenshot of a computer AI-generated content may be incorrect.](./media/image55.png)

11. Verify that the alert dialog has a message that you configured in
    your code. Click **OK** to close the alert.

     ![A red and blue square Description automatically generated](./media/image56.png)

**Summary:** In this lab, you have learnt how to write JavaScript code,
to upload it as a web resource, and to associate it with a form in a
model-driven app to perform a case-insensitive search for Contoso, and
if present, sets values for the websiteurl, telephone1,
and description columns in the account form.
