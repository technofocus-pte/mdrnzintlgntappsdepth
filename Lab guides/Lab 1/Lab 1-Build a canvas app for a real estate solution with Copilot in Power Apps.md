...
1.  Sign into the Power
    Apps +++https://make.powerapps.com/+++ using your
...
5.  You will be navigated to the editing window. Select **Ok** on the
    ...
    ![A white background with black text Description automatically generated](./media/image27.png)
...
5.  Open the link in the new tab and sign in with Brooke Gray’s email
   ...
    +++**brookeg@LODSA7xxxxx.onmicrosoft.com**+++
    ...
    and use the Password as +++**Pa$$w01rd@124**+++.
