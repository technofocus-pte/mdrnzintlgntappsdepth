...
> **Prompt**: I need to manage reimbursement claims in a simple way.
> Employees can submit reimbursement claims for eligible personal travel
> expenses incurred in line with company policies.
>
> Requirements:
...
> An AI agent should automatically review submitted travel claims and
> provide a recommendation (approve or reject) according to the
> guidelines
>
> ![](./media/image4.png)
...
7.  When a plan starts, the **Requirements Agent** identifies user needs
...
8.  The processing agent has generated a set of processes. Here, the
...
10. Select **Show details** to view the data in a diagram and edit it.
    It opens the data workspace.

> ![](./media/image9.png)

11. You can see all the tables in the data workspace. 

> ![](./media/image10.png)

12. Remove all other tables except the **Reimbursement Claim** table. To
    remove a table, click on the **(…) View options** and then select
    **Remove**.
...
14. Select the **Reimbursement Claim** table, then select **View data**
    from the top bar.

> ![](./media/image14.png)

15. You can see the data stored in your table.

> ![](./media/image15.png)

16. Check if you have the **Status** column in the **Reimbursement
    Claim** table.

> ![](./media/image16.png)

17. If you don’t see the **Status** column in the **Reimbursement
    Claim** table, then enter the below prompt to add it to the table.

> **Prompt**: Add column for Status

18. To add one more column to the table, enter the given prompt and
...
19. Check that Copilot has generated the column.

> ![](./media/image18.png)

20. Click on the drop-down menu of the **Status** column and select
    **Edit** column.

> ![](./media/image19.png)

21. Remove all other options. To do this, select the **ellipsis (…)**
    next to the option you want to remove (for example, **Under
    Review**), and then select **Remove**.

> ![](./media/image20.png)

22. In the **Default choice** field, select **Submitted** from the
    drop-down.

> ![](./media/image21.png)

23. The table with sample data is ready. Click **\<-** **Back**.

> ![](./media/image22.png)

24. Select **Looks good** to continue.

> ![](./media/image23.png)

25. The **Solution Agent** analyzes the plan and proposes technologies
    tailored to solve your business problem.

> ![](./media/image24.png)

26. Check if the Solution agent has generated a Model-driven app? If
    not, then select **Edit**.

> ![](./media/image25.png)

27. Enter the given prompt in the text box. Click **send**.

> **Prompt:** Create a Claim Management Hub Model-driven app.
>
> ![](./media/image26.png)

28. The solution agent has generated the Model-driven app. Select
    **Keep**.

> ![](./media/image27.png)

29. Select **Looks good** to accept the technologies.

> ![](./media/image28.png)

30. Select the **Save** icon to save the solution.

> ![](./media/image29.png)

31. Keep the selection as is under the **Select an existing solution**
    option and then select **Save**.

> ![](./media/image30.png)

32. Do not navigate from the current window.
...
22. Select **+Add input** to add one more input field and then add
    **Status**.
...
> +++If approved put \<Enter Value number for Approved\>, if rejected
> put \<Enter Value number for Rejected\>+++
>
> ![](./media/image55.png)
...
5.  In the left pane, under the Agent feed section, select the
    **Completed** tab, and you can see the output.

> ![](./media/image98.png)

6.  Create one more claim and save it.

> **Claim title**: Test
>
> ![](./media/image99.png)

7.  Refresh the page and check under the Needs attention tab, you can
