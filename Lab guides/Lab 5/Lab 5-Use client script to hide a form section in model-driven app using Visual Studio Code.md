...
5.  In this lab, we will use a publisher with the following definition
    ...
    **Prefix** – +++example+++
    ...
    Notice the **Prefix** value. This should be something that identifies your company.
    In this case, we are using example.

7.  You will be now on **New solution** dialog. You can see **Example
...
11. Select **Account** table and then select **Add**.
    ...
    **Note:** For this lab, we are using Account table. The scripts and instructions below expects
    fields found in a form for the Account table.

13. Now, your model-driven app which is named ‘Account App’ is ready.
...
4.  Make sure the **File Type** is **JavaScript (JS)**. Type in
    ...
    **Note**: - Notice how the **Name** has a prefix that matches the solution publisher customization
    prefix. There are other ways to create web resources, but creating a web resource this way ensures
...
**Task 6: Test your code**
    ...
    It is recommended that you refresh your browser for the changes to take effect in your 
    model-driven apps instance.
